    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->pageWelcome->setStyleSheet("background-color: #F5F5F5;");
    ui->labelWelcome->setText(
        "Welcome to MathWorld!\n"
        "\n"
        "This program is designed to help you practice fundamental Calculus topics\n"
        "through interactive questions.\n"
        "\n"
        "Click “Start” to begin your learning journey.\n"
        );

    ui->pageMainMenu->setStyleSheet("background-color: #F5F5F5;");
    ...
    ui->pageTopicSelect->setStyleSheet("background-color: #F5F5F5;");
    ...
    ui->pageQuestion->setStyleSheet("background-color: #F5F5F5;");
    ...
    ui->pageFormulaSelect->setStyleSheet("background-color: #F5F5F5;");
    ...
    ui->pageFeedback->setStyleSheet("background-color: #F5F5F5;");
    ui->pageExitScreen->setStyleSheet("background-color: #F5F5F5;");
